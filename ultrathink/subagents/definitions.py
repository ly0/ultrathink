...
EXPLORE_AGENT = SubagentDefinition(
    ...
    description=(
        ...
        "(1) find files by patterns (e.g., 'src/**/*.tsx', 'tests/*.py'), "
        "(2) search code for keywords or patterns (e.g., 'error handling', 'API endpoints'), "
        "(3) answer questions about codebase structure (e.g., 'how does authentication work?', "
